...
public class GenerateReportServlet extends HttpServlet {
    ...
    public static final String FLAT_PATH = System.getProperty("jboss.home.dir") + "/upload/flat.csv";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        canvas.addImage(ImageDataFactory.create(BG_IMG_PATH),PageSize.Default, false);
    ...
    public void process(Table table, String line, PdfFont font, boolean isHeader) {
        ...
        while (tokenizer.hasMoreTokens()) {
            if (isHeader) {
                ...
                table.addCell(
                        new Cell().add(
                                new Paragraph(tokenizer.nextToken()).setFont(font))).setFontSize(8f).setMaxHeight(UnitValue.createPointValue(10));
            }
        }
    }
