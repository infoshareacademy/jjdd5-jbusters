...
@WebServlet(urlPatterns = ("/add-user-form"))
public class LoadRegistrationFormServlet extends HttpServlet {

    private static final Logger LOG = LoggerFactory.getLogger(LoadRegistrationFormServlet.class);
    private static final String TEMPLATE_NAME_GUEST = "registration-user-form";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            LOG.info("Loaded registration form");
        } catch (TemplateException e) {
            LOG.error("Failed to registration form");
        }
    }
}
